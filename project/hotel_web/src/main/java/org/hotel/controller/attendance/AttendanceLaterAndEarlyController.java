 ...
 */
@Controller
@RequestMapping("attendanceLaterAndEarly")
public class AttendanceLaterAndEarlyController {

private final String urlStr = "attendanceLaterAndEarly";
	...
	public String index(HttpServletRequest request){
		...
		return "work/attendanceLaterAndEarly";
	}
	...
	public @ResponseBody Map<String, Object> pageDatas(HttpServletRequest request){
		...
		List<AttendanceExceptional> attendanceExceptionals = attendanceExceptionalService.findAttendanceExceptionalByOrgs(orgs);
	...
	public @ResponseBody String exportExcels(HttpServletRequest request,HttpServletResponse response){
		try{
	        ...
	        if(null == null){
	        	field = new String[]{"员工编号-StaffNo","员工姓名-StaffName","所属部门-OrgName","考勤日期-AttendanceTime","状态-ExceptionType","班次-WorkOrderName","班次类型-WorkOrderTypeName","刷卡1-Brush1","刷卡2-Brush2","刷卡3-Brush3","刷卡4-Brush4","刷卡5-Brush5","刷卡6-Brush6","刷卡7-Brush7","刷卡8-Brush8"};
	        }
	        ...
	        exceptions.add(ATTENDANCEEXCEPTION.LATER.getValue());
	        exceptions.add(ATTENDANCEEXCEPTION.EARLYQUIT.getValue());
