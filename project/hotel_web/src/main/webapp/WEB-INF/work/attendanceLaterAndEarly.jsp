							...
							<div class="col-xs-12">
								...
								<div class='col-lg-10'>
									<div class="searchDiv">
									 ...
									 <div id="attendancebrush_grid"></div>
								</div>
								<!-- PAGE CONTENT ENDS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
...
<!--  dialog  -->
		<div id="attendanceLaterAndEarly_export_dialog" class="dialog-model"><%@ include file="attendanceLaterAndEarly_export_dialog.jsp"%></div>
		<script type="text/javascript">
			<%@ include file="attendanceLaterAndEarly.js"%>
		</script>
</body>
</html>
