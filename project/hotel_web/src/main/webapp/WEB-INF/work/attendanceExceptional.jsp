...
.ui-button{
	...
	<body>
								...
								<div class='col-lg-10'>
									<div class="searchDiv">
										<form class="form-inline">
										  ...
										  <div class="form-group">
										    <label for="exampleInputEmail2">考勤日期</label>
									 ...
									 <div id="attendanceExceptional_grid"></div>
								</div>
								<!-- PAGE CONTENT ENDS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
		...
		<div id="attendanceExceptional_export_dialog" class="dialog-model"><%@ include file="attendanceExceptional_export_dialog.jsp"%></div>
<!--  dialog  -->
		<script type="text/javascript">
			<%@ include file="attendanceExceptional.js"%>
		</script>
</body>
</html>
