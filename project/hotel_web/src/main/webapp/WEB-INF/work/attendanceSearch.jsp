							...
							<div class="col-xs-12">
								...
								<div class='col-lg-10'>
									<div class="searchDiv">
									 ...
									 <div id="attendanceSearch_grid"></div>
								</div>
								<!-- PAGE CONTENT ENDS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
...
<!--  dialog  -->
<div id="attendanceSearch_export_dialog" class="dialog-model"><%@ include file="attendanceSearch_export_dialog.jsp"%></div>
		<script type="text/javascript">
			<%@ include file="attendanceSearch.js"%>
		</script>
</body>
</html>
