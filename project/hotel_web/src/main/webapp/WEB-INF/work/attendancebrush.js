    $(function () {
    	//首先定义表格选项
    	var tabId = $("#attendancebrush_grid");
    	var dataModel = {
    			 	cache: true,
//    	            recIndx: "customerid",
...
//            height: 400,
        ...
        function tab_export() {
          	var delMsg = '<div class="dialog-cls"><form id="export_from" class="form-horizontal" role="form">'+$("#attendancebrush_export_dialog").html()+'</form></div>';
          	bootbox.dialog({
          		  message: delMsg,
          		  title: "导出列表",
          		  buttons: {
          		    success: {
          		      ...
          		      callback: function() {
          		    	  window.open("exportPdf?"+$("#export_from").serialize());
          		      }
          		    },
          		    canle:{
     	            	 label: "取消",
