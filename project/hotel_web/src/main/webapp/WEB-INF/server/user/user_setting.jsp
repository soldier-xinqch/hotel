...
<!--  dialog   -->
<div id="user_dialog" class="dialog-model"><%@ include file="user_dialog.jsp"%></div>
<div id="user_auth" class="dialog-model"><%@ include file="user_auth.jsp"%></div>
<div id="user_edit_passwd" class="dialog-model"><%@ include file="user_edit_passwd.jsp"%></div>
